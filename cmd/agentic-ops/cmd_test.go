...
func TestDiscoverCommand(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "agentic-ops-discover-*")
	if err != nil {
		t.Fatal(err)
	}
...
func TestValidateCommand(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "agentic-ops-validate-*")
	if err != nil {
		t.Fatal(err)
	}
	defer func() { _ = os.RemoveAll(tmpDir) }()
...
func TestValidateCommandDir(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "agentic-ops-validate-dir-*")
	if err != nil {
		t.Fatal(err)
	}
	defer func() { _ = os.RemoveAll(tmpDir) }()
...
func TestRunCommandEmptyEvent(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "agentic-ops-run-*")
	if err != nil {
		t.Fatal(err)
	}
	defer func() { _ = os.RemoveAll(tmpDir) }()
...
func TestRunCommandWithEvent(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "agentic-ops-run-event-*")
	if err != nil {
		t.Fatal(err)
	}
	defer func() { _ = os.RemoveAll(tmpDir) }()
...
func TestRunCommandInvalidJSON(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "agentic-ops-run-invalid-*")
	if err != nil {
		t.Fatal(err)
	}
	defer func() { _ = os.RemoveAll(tmpDir) }()
...
func TestRunCommandNonexistentWorkflow(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "agentic-ops-run-noworkflow-*")
	if err != nil {
		t.Fatal(err)
	}
	defer func() { _ = os.RemoveAll(tmpDir) }()
...
func TestFindWorkflowFileYAML(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "agentic-ops-find-yaml-*")
	if err != nil {
		t.Fatal(err)
	}
	defer func() { _ = os.RemoveAll(tmpDir) }()
...
func TestRunWorkflowFound(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "agentic-ops-run-workflow-*")
	if err != nil {
		t.Fatal(err)
	}
	defer func() { _ = os.RemoveAll(tmpDir) }()
...
func TestRunMatchingWorkflowsWithMatchingWorkflow(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "agentic-ops-matching-*")
	if err != nil {
		t.Fatal(err)
	}
	defer func() { _ = os.RemoveAll(tmpDir) }()
...
func TestRunMatchingWorkflowsNoMatch(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "agentic-ops-nomatch-*")
	if err != nil {
		t.Fatal(err)
	}
	defer func() { _ = os.RemoveAll(tmpDir) }()
...
func TestRunMatchingWorkflowsEmptyDir(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "agentic-ops-empty-*")
	if err != nil {
		t.Fatal(err)
	}
	defer func() { _ = os.RemoveAll(tmpDir) }()
